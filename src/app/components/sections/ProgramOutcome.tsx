...
import left from "@/app/components/assets/images/Left.png";

const outcomesPoints = [
  "Product Ownership",
  "Freelacing",
  "Global Marketing DAO",
  "Boosting Economy.",
];
const ProgramOutcome = () => {
  return (
    <section className="mt-16 md:m-28">
      <Wrapper>
        <div className="flex gap-x-8 items-center flex-col-reverse md:flex-row ">
          {/* left side */}
          <div className="flex-1">
            <Image src={left} alt="programoutcome" />
          </div>
          {/*right side  */}
          <div className="flex-1">
